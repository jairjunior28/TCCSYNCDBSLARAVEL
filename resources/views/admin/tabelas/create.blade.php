...
<div class="container">
    ...
    {!! Form::open(['url' => '/admin/tabelas', 'class' => 'form-horizontal']) !!}
                ...
                <div class="col-sm-6">
                    {!! Form::select('id_configuracao',$configuracoes::lists('titulo','id') , ['class' => 'form-control', 'required' => 'required','id'=>'id_configuracao']) !!}
